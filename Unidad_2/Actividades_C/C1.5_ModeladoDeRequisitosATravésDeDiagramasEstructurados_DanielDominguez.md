...
2. Elabore los siguientes diagramas:
   ...
   <p align="center">
    <img alt="Ilustración" src="../../img/U2/C1.5_DiagramaDeEstado.png" width=100%>
    </p>

   + Diagrama de **de componentes**

   <p align="center">
    <img alt="Ilustración" src="../../img/U2/C1.5_DiagramaComponentes.png" width=100%>
    </p>

   + Diagrama de **de distribución**

   <p align="center">
    <img alt="Ilustración" src="../../img/U2/C1.5_DiagramaDistribución.png" width=100%>
    </p>
___
